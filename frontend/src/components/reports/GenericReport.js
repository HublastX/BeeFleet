...
const GenericReport = ({ isOpen, reportData, filters }) => {
   ...
   const exportExcel = async () => {
      ...
      reportData.managers.forEach((manager) => {
   ...
   return (
      <div className="p-0 flex justify-center text-black fixed top-0 left-0 w-full h-full bg-white overflow-y-auto">
         <div className="print-area  w-1/2 bg-white text-black h-full">
            {/* Cabeçalho */}
            ...
            <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                           <div className="p-4 rounded-lg border bg-red-50">
                              ...
                              <p className="text-xl font-bold text-red-700">
                                 {reportData.globalStats.totalDeletedDrivers ||
                                    0}
                              </p>
                           </div>
                           <div className="p-4 rounded-lg border bg-red-50">
                           ...
                           <div className="p-4 rounded-lg border bg-red-50">
                              ...
                              <p className="text-xl font-bold text-red-700">
                                 {reportData.globalStats.totalDeletedEvents ||
                                    0}
                              </p>
                           </div>
                        </div>
                                    ...
                                    {reportData.managers
                                       ...
                                       .map((event) => (
                                          <tr key={event.id}>
                                             ...
                                             <td className="px-6 py-4 whitespace-wrap flex flex-col">
               ...
               {showCars && (
                  <section>
                     ...
                     <div className="overflow-x-auto">
                        {reportData.managers.flatMap((manager) => manager.cars)
                           .length > 0 ? (
                           <table className="min-w-full divide-y divide-gray-200">
                              <thead className="bg-gray-50">
                                 <tr>
            ...
            <footer className="mt-8 pb-3 pt-6 border-t border-bee-dark-300">
               <div className="flex justify-between items-center">
                  <div className="text-xs text-gray-500">
                     <p>
                        Relatório gerado automaticamente pelo sistema Bee Fleet
                     </p>
                     <p className="mt-1">
