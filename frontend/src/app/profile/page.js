   ...
   return (
      <div className="p-4 space-y-6">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Link href="profile/drivers" className="p-6  rounded-lg shadow-theme-lg">
               <h2 className="text-lg font-semibold mb-2">
                  Total de motoristas adicionados
               </h2>
               <p className="text-4xl font-black text-bee-yellow-700">{myDriversCount}</p>
            </Link>

            <Link href="profile/cars" className="p-6 rounded-lg shadow-theme-lg">
               <h2 className="text-lg font-semibold mb-2">
                  Total de carros adicionados
               </h2>
               <p className="text-4xl font-black text-bee-yellow-700">{myCarsCount}</p>
            </Link>

            <Link href="profile/eventos" className="p-6 rounded-lg shadow-theme-lg">
               <h2 className="text-lg font-semibold mb-2">
